...
import com.github.snd297.yp.proxies.persistence.Circle;
import com.github.snd297.yp.proxies.persistence.Rectangle;
import com.github.snd297.yp.proxies.persistence.Shape;
import com.github.snd297.yp.proxies.persistence.Square;
  ...
  public void whatToDo() {
    ...
    try {
      ...
      for (Shape shape : shapes) {
        if (HibernateUtil.isInstanceOf(shape, Rectangle.class)) {
          ...
          foundRectangle = true;
        } else if (HibernateUtil.isInstanceOf(shape, Circle.class)) {
